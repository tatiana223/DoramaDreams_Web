...
export const MOCK_ACTORS: Actor[] = [
  {
    ...
    fullName: "Ким Су Хён",
    originalName: "김수현",
    photoUrl: "https://m3.doramalives.news/upload/iblock/c31/kim_soo_hyun_279658.jpg",
  ...
  },
  {
    ...
    originalName: "김지원",
    photoUrl: "D:/BMSTU/diplom/doramadreams/doramadreams_frontend_mock_fallback_patch/frontend/public/grin_828214.jpg",
...
const SAMPLE_VIDEO_URL = "https://www.youtube.com/embed/ysz5S6PUM-U";
...
export function getMockEpisodes(doramaId: number): DoramaEpisode[] {
  return [...(MOCK_DORAMA_EPISODES[doramaId] ?? [])];
}
