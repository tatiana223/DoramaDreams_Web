  ...
  return (
    <div className="min-h-screen bg-[#faf8ff] text-slate-950">
      <header className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        ...
        <Button
          variant="outline"
          className="rounded-full border-violet-200 bg-white text-violet-700 hover:bg-violet-50"
        >
          Войти
        </Button>
      </header>
      ...
      <main className="relative overflow-hidden">
        ...
        <section className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-5xl flex-col items-center justify-center px-6 py-16 text-center">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Button
              size="lg"
              className="rounded-full bg-violet-600 px-8 text-base font-semibold shadow-lg shadow-violet-200 hover:bg-violet-700"
            >
              Войти
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full border-violet-200 bg-white px-8 text-base font-semibold text-violet-700 hover:bg-violet-50"
            >
              Зарегистрироваться
            </Button>
          </div>
