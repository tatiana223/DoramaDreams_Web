...
public class DoramaService {
    ...
    public List<DoramaDto> getDoramas(String title, String genre, String tag, String country, Integer releaseYear) {
        if (isBlank(title) && isBlank(genre) && isBlank(tag) && isBlank(country) && releaseYear == null) {
            return getAllDoramas();
        }

        return searchDoramas(title, genre, tag, country, releaseYear);
    }
